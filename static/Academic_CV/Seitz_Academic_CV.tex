...
\begin{document}
	...
	\begin{tabular}[t]{@{}p{\textwidth-\rcollength-\spacewidth}@{}p{\spacewidth}@{}p{\rcollength}}%
		...
		\parbox{\textwidth-\rcollength-\spacewidth}{%
			...
			Research Scientist\\
			\href{https://instadeep.com/}{InstaDeep}\\
			Genomics AI Research Team\\
	...
	Developing machine learning methods to decode biological complexity — from gene regulation to 3D molecular structure.
	...
	\begin{outerlist}
		...
		\item[] \textbf{Research Scientist}, September 2025 -- present
	
	\begin{innerlist}
		\item[$-$] Team: Genomics AI Research
		\item[$-$] Contact: \email{e.seitz@instadeep.com}
		\item[$-$] Summary:	Developing genomic large language models (gLMs) and other AI-driven approaches for genomic research.
	\end{innerlist}
	...
	\begin{outerlist}
		...
		\item[] \textbf{Computational Postdoctoral Fellow}, March 2022 -- September 2025
	...
	\begin{innerlist}
		...
		\item[$-$] Affiliations:
			...
			\end{innerlist}	
		\item[$-$] Summary:	My postdoctoral work produced SEAM and SQUID, two interpretability frameworks for genomic deep learning, including a publication in \href{https://www.nature.com/articles/s42256-024-00851-5} {Nature Machine Intelligence} and a \href{https://www.biorxiv.org/content/10.1101/2025.10.07.681052v1}{preprint} currently under review.
		\item[$-$] Awards:
			\begin{innerlist}
			\item[$-$] 
...
\end{outerlist}
	...
	\section{Conference\ \ \ \ Talks}	
		\begin{bibenum}
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. "Decoding the Mechanistic Impact of Genetic Variation on Regulatory Sequences with Deep Learning". \href{https://meetings.cshl.edu/meetings.aspx?meet=INFO&year=25}{Genome Informatics}, Cold Spring Harbor Laboratory, November 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. "Mapping the Mechanistic Impact of Genetic Variation with Interpretable Deep Learning". \href{https://www.keystonesymposia.org/conferences/conference-listing/meeting/g22026}{Keystone Symposia: AI in Molecular Biology}, Santa Fe, NM, September 17, 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Spotlight Poster presentation: "Decoding the Mechanistic Impact of Genetic Variation on Regulatory Sequences with Deep Learning". \href{https://www.mlcb.org/}{Machine Learning in Computational Biology}, September 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. “Decoding the Mechanistic Impact of Genetic Variation on Regulatory Sequences with Deep Learning,” \href{https://www.gembio.ai/}{Generative and Experimental Perspectives for Biomolecular Design} (GEM) Workshop, \href{https://iclr.cc/}{International Conference on Learning Representations} (ICLR), Singapore, April 2025.
			\begin{innerlist}
				\item URL: \href{https://openreview.net/forum?id=PtjMeyHcTt}{https://openreview.net/forum?id=PtjMeyHcTt}
			\end{innerlist}
	...
	\section{Conference\ \ \ \ Posters}
		...
		\begin{bibenum}
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Mapping the Mechanistic Impact of Genetic Variation with Interpretable Deep Learning. \href{https://www.keystonesymposia.org/conferences/conference-listing/meeting/g22026}{Keystone Symposia: AI in Molecular Biology}, September 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Decoding the Mechanistic Impact of Genetic Variation on Regulatory Sequences with Deep Learning. \href{https://www.mlcb.org/}{Machine Learning in Computational Biology}, September 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Mapping the Mechanistic Impact of Genetic Variation with Interpretable Deep Learning. \href{https://www.grc.org/human-genetics-and-genomics-conference/2025/}{Human Genetics and Genomics}, Gordon Research Conference and Gordon Research Seminar, July 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Mapping the Mechanistic Impact of Genetic Variation with Interpretable Deep Learning. \href{https://www.grc.org/human-genetics-and-genomics-conference/2025/}{Human Genetics and Genomics}, Gordon Research Conference and Gordon Research Seminar, July 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Decoding the Mechanistic Impact of Genetic Variation on Regulatory Sequences with Deep Learning. \href{https://meetings.cshl.edu/abstracts.aspx?meet=GENOME&year=25}{Biology of Genomes}, Cold Spring Harbor Laboratory, May 2025.
			
			\item E. Seitz, D. McCandlish, J. Kinney and P. Koo. Deciphering the determinants of mechanistic variation in regulatory sequences. \href{https://meetings.cshl.edu/meetings.aspx?meet=PROBGEN&year=25}{Probabilistic Modeling in Genomics}, Cold Spring Harbor Laboratory, March 2025.
	...
	\section{Other\ \ \ \ \ \ \ \ Publications}
		...
		\begin{bibenum}
			\item S. Boshar et al., "A foundational model for joint sequence-function multi-species modeling at scale for long-range genomic prediction."\\bioRxiv, 2025.\\\href{https://doi.org/10.64898/2025.12.22.695963} {https://doi.org/10.64898/2025.12.22.695963}
	...
	\section{Advising and Mentoring}
		...
		\begin{outerlist}
			...
			(2024)
    			...
    			\item \textbf{Sophia Chen}\\
			High school student attending Farragut High School, NY.
			Computational research on meta-interpretability of genomic DNNs
			(2025)
...
\begin{outerlist}
	...
	\begin{innerlist}
		\item Directed a team of animators for creating a series of educational videos detailing scientific research done by \href{https://www.gsb.stanford.edu/faculty-research/faculty/jennifer-lynn-aaker} {Dr. Jennifer Aaker} and colleagues at Stanford on topics including empathy, humor, and purpose. The following videos premiered at the \href{https://futureofstorytelling.org/summit}{\emph{Future of StoryTelling Summit}} in NYC
		 \begin{innerlist}
...
\section{Professional Service}
	...
	\begin{innerlist}
		\item \emph{Nature Machine Intelligence} (July 2026)
		\item \emph{NeurIPS SPIGM} (2025)
		\item \emph{NeurIPS AI4Science} (2025)
		\item \emph{ACM Bioinformatics, Computational Biology, and Health Informatics} (2025)
		\item \emph{ICML 2025 GenBio Workshop} (2025)
...
\begin{innerlist}
	\item Scientific illustrator and figure synthesis lead for Boshar et al., "A foundational model for joint sequence-function multi-species modeling at scale for long-range genomic prediction," bioRxiv, 2025: \href{https://doi.org/10.64898/2025.12.22.695963} {https://doi.org/10.64898/2025.12.22.695963}
...
Prior to entering science, I worked professionally in 2D/3D animation and motion design. Projects included clients such as Coca-Cola, Cirque du Soleil, and Stanford University. A portfolio and full history are available on my \href{https://www.linkedin.com/in/eeseitz}{LinkedIn profile}. 
...
\section{Additional Training}
	...
	\begin{innerlist}
		...
		\item Expertise in Python, with significant experience using TensorFlow, PyTorch, NumPy, Scipy, Pandas, Matplotlib, Mayavi, PyQt, TraitsUI and Anaconda, among others
...
\section{Software\ \ \ \ Distributions}
		\begin{innerlist}
			\item E. Seitz et al., "SEAM Python repository: Systematic explanation of attribution-based mechanisms for regulatory genomics," 2024-2025. \href{https://github.com/evanseitz/seam-nn}{https://github.com/evanseitz/seam-nn}\\
			$-$ Read the Docs: \href{https://seam-nn.readthedocs.io} {https://seam-nn.readthedocs.io}
	...
	\begin{innerlist}
		\item[$-$] \emph{I worked in Dr.~Koo's lab as a Computational Postdoctoral Fellow from March 2022 to September 2025}
	...
	\begin{innerlist}
		\item[$-$] \emph{I worked in Dr.~Kinney's lab as a Computational Postdoctoral Fellow from March 2022 to September 2025}
		\item[$\diamond$] \href{https://www.cshl.edu/research/quantitative-biology/} {Simons Center for Quantitative Biology}, Cold Spring Harbor Laboratory, Cold Spring Harbor, NY 11724 USA
	\end{innerlist}
	...
	\begin{innerlist}
		\item[$-$] \emph{I collaborated with Dr.~McCandlish during my postdoctoral fellowship from March 2022 to September 2025}
		\item[$\diamond$] \href{https://www.cshl.edu/research/quantitative-biology/} {Simons Center for Quantitative Biology}, Cold Spring Harbor Laboratory, Cold Spring Harbor, NY 11724 USA
	\end{innerlist}
