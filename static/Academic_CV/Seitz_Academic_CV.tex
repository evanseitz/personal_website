...
\begin{document}
	...
	Developing interpretable machine learning methods to decode biological complexity — from 3D molecular structure to gene regulation.
	...
	\begin{innerlist}
		...
		\item[$-$] Affiliations:
			...
			\end{innerlist}	
		\item[$-$] Summary:	My postdoctoral work has produced SEAM and SQUID, two interpretability frameworks for genomic deep learning, including a publication in \href{https://www.nature.com/articles/s42256-024-00851-5} {Nature Machine Intelligence} and an invited talk at \href{https://openreview.net/forum?id=PtjMeyHcTt} {ICLR GEM}.
		\item[$-$] Awards:
			\begin{innerlist}
			\item[$-$] 
